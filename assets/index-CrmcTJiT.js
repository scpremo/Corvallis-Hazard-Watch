...
<p> Description: `+this.text+"</p>"),this.visible=!0}}}class jt{constructor(t,o,r,s,d){this.hazardList=t,this.icons=d,this.hazTypes=r,this.size=t.length,this.current=0,this.grouped=!1,this.filteredData,this.groupedContainer=new Array;var m=this.size;this.api=s,this.container,this.map=o,this.size<50?(this.size*=2,this.container=new Array(2*this.size)):(this.size=100,this.container=new Array(100));for(let x=0;x<m;x++){let v=JSON.parse(JSON.stringify(this.hazardList[x]));v.created_at=new Date(v.created_at),this.insert(v)}this.currentDate=new Date}insert(t){var o=new ze(t,this.map,this.hazTypes,this.icons);this.current==this.size&&this.grow(),this.container[this.current++]=o,this.filteredData&&this.filteredData.push(o)}insert(t,o,r,s){var d=new ze(t,this.map,this.hazTypes,this.icons);this.current==this.size&&this.grow(),this.container[this.current++]=d,s&&this.filter(o,r,s)}update(t,o,r,s){this.removeAll(),this.container=new Array(2*t.length);let d=t.length;this.current=0;for(let m=0;m<d;m++){let x=JSON.parse(JSON.stringify(t[m]));x.created_at=new Date(x.created_at),this.insert(x)}this.filter(o,r,s)}grow(){var t=this.container;this.container=new Array(2*this.size);for(let o=0;o<this.size;o++)this.container[o]=t[o]}at(t){return this.container[t]}viewAll(){for(let t=0;t<this.current;t++)this.container[t].show()}removeAll(){for(let t=0;t<this.current;t++)this.container[t].remove()}filter(t,o,r){this.groupedContainer.forEach(s=>{s[2]!=="loc"&&s[3].remove()}),delete this.filteredData,this.filteredData=new Array,this.viewAll(),this.filterByTime(t,o),this.filterByType(r);for(let s=0;s<this.current;s++)this.container[s].isVisible()&&this.filteredData.push(this.container[s]);this.grouped&&(this.grouped=!1,this.group())}filterByTime(t,o){for(let r=0;r<this.current;r++)this.container[r].dateObject.getTime()>t.getTime()&&this.container[r].dateObject.getTime()<o.getTime()||this.container[r].remove()}filterByType(t){if(t!="All")for(let o=0;o<this.current;o++)t.includes(this.container[o].type)||this.container[o].remove()}unGroup(t,o,r,s){this.grouped&&(this.grouped=!1,this.filter(t,o,r),this.groupedContainer.forEach(d=>{d[2]!=="loc"&&d[3].remove()}))}async group(){if(!this.grouped){this.removeAll(),this.grouped=!0,delete this.groupedContainer,this.groupedContainer=new Array,this.filteredData.forEach(o=>{var r=!1;for(let s=0;s<this.groupedContainer.length;s++)if(this.groupedContainer[s][0]===o.location){this.groupedContainer[s][1].push(o),r=!0;continue}r||this.groupedContainer.push([o.location,[o],"loc","marker"])});const t=this.groupedContainer.map(o=>fetch(`https://api.openweathermap.org/geo/1.0/direct?q=${o[0]}&limit=1&appid=${this.api}`).then(r=>{if(!r.ok)throw new Error("Network response was not ok");return r.json()}).then(r=>{r[0]&&(o[2]=[r[0].lat,r[0].lon])}).catch(r=>{console.error("There was a problem with the fetch operation:",r)}));Promise.all(t).then(()=>{this.groupedContainer.forEach(o=>{if(o[2]!=="loc"){var r=L.icon({iconUrl:"/assets/icons/marker-icon.png",shadowUrl:"/assets/icons/marker-shadow.png",iconSize:[25,41],shadowSize:[41,41],iconAnchor:[12,41],shadowAnchor:[12,41],popupAnchor:[-3,-41]}),s=L.marker(o[2],{icon:r});s.addTo(this.map),s.bindPopup("<b>"+o[1].length+" hazards reported in this area</p>"),o[3]=s}})})}}}const Ct="https://hknrbmfihwwaepwhfhbi.supabase.co",St="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhrbnJibWZpaHd3YWVwd2hmaGJpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjEyNDA2OTAsImV4cCI6MjAzNjgxNjY5MH0.pgIz0EqpbQFXXLlu5m-8ejB8Q6jjXYv1V2uqBTY3HpA",Dt=Ee(Ct,St),ke=()=>{var a;const t=W(dt),o=u.useRef(null),r=u.useRef(null);u.useState(!1);const s=new Date,d=new Date(s.getTime()+24*60*60*1e3),m=new Date(s.getTime()-24*60*60*1e3),[x,v]=u.useState(),[I,w]=u.useState(),[R,P]=u.useState(!1),[y,Y]=u.useState({}),[f,G]=u.useState(null),[oe,O]=u.useState(!1),A=W($e),X=W(De),he=W(xt),[z,pe]=u.useState(null),ie=Fe(),Z="bed1848ba67a4ff12b0e3c2f5c0421fe",{lat:q,lon:c,time:l}=tt();u.useState(!1);const[g,p]=u.useState(),[C,S]=u.useState(0);Ce();function T(){navigator.permissions?navigator.permissions.query({name:"geolocation"}).then(n=>{n.state==="granted"?H():n.state==="prompt"?navigator.geolocation.getCurrentPosition(i=>{H()},i=>{console.error("Error getting user location:",i.message)}):console.error("Geolocation permission denied or unavailable.")}):console.error("Permissions API is not supported in this browser.")}function H(){navigator.geolocation.getCurrentPosition(n=>{const i=n.coords.latitude,h=n.coords.longitude;return f.setView([i,h],14),h},n=>{console.error("Error getting user location:",n.message)})}function J(n){var i=document.getElementById(`circleRadio${n}`),h=document.getElementById(`radiusSlider${n}`);i.checked?h.style.display="block":h.style.display="none"}function ue(n){var i=document.getElementById(`pointRadio${n}`);return i.checked?"Point":"Circle"}function me(n){var i=document.getElementById(`circleRadio${n}`),h=document.getElementById(`radius${n}`);return i.checked?h.value:0}function fe(){f.closePopup()}function ge(n,i,h,b,k,N,F,E,U){const se=document.getElementById(`bad-length${U}`);var V=document.getElementById(`bad-words${U}`);V.style.display="none",se.style.display="none";const $=new et;if(i<-180||i>180){var n=n-Math.floor((n+90)/180)*180,i=i-Math.floor((i+180)/360)*360;f.setView([n,i],13)}if(F.length>200){const j=document.getElementById(`bad-length-value${U}`);se.style.display="block",j.textContent=F.length-200+" characters over the limit";const M=f.getSize(),K={lat:n,lng:i},ve=f.getBounds(),we=f.containerPointToLatLng([M.x/2,M.y-0]),je=K.lat-(we.lat-ve.getCenter().lat);f.panTo([je,K.lng])}else if($.isProfane(F)){const j=xe(F,$.clean(F));var Q=document.getElementById(`bad-words-found${U}`);Q.textContent=j,V.style.display="block";const M=f.getSize(),K={lat:n,lng:i},ve=f.getBounds(),we=f.containerPointToLatLng([M.x/2,M.y-0]),je=K.lat-(we.lat-ve.getCenter().lat);f.panTo([je,K.lng])}else ye(n,i,h,b,N,F),f.closePopup()}function xe(n,i){const h=n.split(" "),b=i.split(" ");var k="";for(let N=0;N<h.length;N++)b[N].includes("*")&&(k+=h[N]+" ");return k}const ye=async(n,i,h,b,k,N)=>{var F="N/A";try{const j=await(await fetch(`https://api.openweathermap.org/geo/1.0/reverse?lat=${n}&lon=${i}&limit=1&appid=${Z}`)).json();j[0]&&j[0].country&&j[0].country==="US"?F=`${j[0].name},${j[0].state}, ${j[0].country}`:j[0]&&j[0].country?F=`${j[0].name}, ${j[0].country}`:F="N/A"}catch($){throw console.error($),new Error("Error fetching location data")}k==0&&(k=null);let E={latitude:n,longitude:i,created_at:b,type:parseInt(h,10),icon_type:null,text:N,image:null,creator_id:10,radius:k,location:F};const U=new Date(x),se=new Date(I);var V=Object.keys(y).filter($=>y[$]);V.length===0&&(V="All"),z.insert(E,U,se,V),E.created_at=E.created_at.toLocaleString(),ie(lt(E));try{const{data:$,error:Q}=await Dt.from("hazards").insert([{type:E.type,latitude:E.latitude,longitude:E.longitude,text:E.text,radius:E.radius,location:E.location}]).select();if(Q)throw Q}catch($){console.error($)}},ne=n=>{const i=Math.floor(Math.random()*1e8)+1;var h=`
                  ...
                  `;a=ae.popup().setLatLng(n.latlng).setContent(h).openOn(f),document.getElementById(`pointRadio${i}`).addEventListener("click",()=>J(i)),document.getElementById(`circleRadio${i}`).addEventListener("click",()=>J(i)),document.getElementById(`closeButton${i}`).addEventListener("click",()=>fe()),document.getElementById(`radius${i}`).addEventListener("input",()=>{document.getElementById(`radiusValue${i}`).textContent=document.getElementById(`radius${i}`).value}),document.getElementById(`submitButton${i}`).addEventListener("click",()=>ge(n.latlng.lat,n.latlng.lng,document.getElementById(`hazard${i}`).value,new Date,ue(i),me(i),document.getElementById(`textInput${i}`).value,a,i))},be=async()=>{ie(Se()),p(!0)};u.useEffect(()=>{if(g&&A.length!=C&&z){const i=new Date(x),h=new Date(I);var n=Object.keys(y).filter(b=>y[b]);n.length===0&&(n="All"),z.update(A,i,h,n),S(A.length),p(null)}},[A,g]),u.useEffect(()=>{if(A.length>0){const n=()=>{if(!o.current._leaflet_id)if(!isNaN(parseFloat(q))&&!isNaN(parseFloat(c))&&!isNaN(parseFloat(l))){const i=new Date(parseFloat(l)-864e5),h=new Date(parseFloat(l)+24*60*60*1e3);v(i.toISOString()),w(h.toISOString()),G(ae.map(o.current).setView([parseFloat(q),parseFloat(c)],18))}else v(m.toISOString()),w(d.toISOString()),G(ae.map(o.current).setView([44.564568,-123.262047],15))};o.current&&n()}return()=>{}},[A]),u.useEffect(()=>{if(f&&!oe){O(!1),ae.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(f),r.current=f;const n=new jt(A,f,X,Z,he);S(A.length),pe(n),isNaN(parseFloat(q))&&T()}},[f,oe]),u.useEffect(()=>{if(z){Date.now()-t>5*1e3&&be(),f.on("click",h=>ne(h));var n,i;isNaN(parseFloat(l))?(n=m,i=d):(n=new Date(parseFloat(l)-24*60*60*1e3),i=new Date(parseFloat(l)+24*60*60*1e3)),z.filter(n,i,"All"),f.on("zoomend",function(){f.getZoom()>=13?Ue():Je()})}},[z]);const Ie=()=>{const n=new Date(x),i=new Date(I);var h=Object.keys(y).filter(b=>y[b]);h.length===0&&(h="All"),z.filter(n,i,h)},We=n=>{Y(i=>({...i,[n]:!i[n]}))},Je=()=>{z.group()},Ue=()=>{const n=new Date(x),i=new Date(I);var h=Object.keys(y).filter(k=>y[k]);h.length===0&&(h="All"),z.unGroup(n,i,h,Z),Ie();const b=document.getElementById("desperate");if(b){const k=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});b.dispatchEvent(k)}},Ve=Ke`
 text-align: right;
 position: relative;
 z-index: 1000;
`;return re("div",{children:[B("div",{css:Ve,children:x&&I&&re("div",{children:["Start Date:",B("input",{type:"date",id:"startDate",value:x.split("T")[0],onChange:n=>v(n.target.value)}),"End Date:",B("input",{type:"date",id:"endDate",value:I.split("T")[0],onChange:n=>w(n.target.value)}),re("div",{id:"list1",className:"dropdown-check-list",tabIndex:"100",children:[B("span",{className:"anchor",onClick:()=>P(!R),children:"Hazard Types"}),R&&B("ul",{className:"items",children:X.map(n=>re("li",{children:[B("input",{id:n.id,value:n.name,type:"checkbox",checked:y[n.name]||!1,onChange:()=>We(n.name)}),n.name]},n.id))})]}),B("button",{id:"desperate",onClick:Ie,children:"Submit"})]})}),B("div",{ref:o,id:"map",style:{height:"70vh"}}),B("p",{children:"To create a hazard, first be signed in, then click anywhere on the map"})]})},te=D(de)`
  font-size: large;
...
`,Ft=()=>(Ce(),e.jsx(kt,{children:e.jsxs("ul",{className:"links",children:[e.jsx("li",{className:"start",children:e.jsx(te,{to:"/Corvallis-Hazard-Watch/",title:"Home",children:"Home"})}),e.jsx("li",{children:e.jsx(te,{to:"/Corvallis-Hazard-Watch/map",title:"Map",children:"Map"})}),e.jsx("li",{children:e.jsx(te,{to:"/Corvallis-Hazard-Watch/dataView",className:"dataView",children:"DataView"})}),e.jsx("li",{children:e.jsx(te,{to:"/Corvallis-Hazard-Watch/about",title:"About",children:"About"})})]})})),Et=({id:a,created_at:t,type:o,latitude:r,longitude:s,text:d,radius:m,location:x,onClick:v})=>{var y;const I=W(De),w=_.td`
        border-style: solid;
        padding: 8px;
        text-align: left;
    `,R=new Date(t),P=()=>{v&&v({latitude:r,longitude:s})};return e.jsxs("tr",{onClick:P,children:[e.jsx(w,{children:a}),e.jsx(w,{children:R.toLocaleString()}),e.jsx(w,{children:((y=I.find(Y=>Y.id===o))==null?void 0:y.name)||"Other"}),x==="N/A"?e.jsxs(w,{children:[r,",",s]}):e.jsx(w,{children:x}),e.jsx(w,{children:d}),e.jsx(w,{children:m})]})},At=()=>{const a=W($e),[t,o]=u.useState([]),r=W(De),s=new Date;u.useState();const d=new Date(s.getTime()-3*31*24*60*60*1e3),[m,x]=u.useState(d.toISOString()),[v,I]=u.useState(s.toISOString()),[w,R]=u.useState(!1),[P,y]=u.useState({});u.useRef();const Y=ot(),f=()=>{x(d.toISOString()),I(s.toISOString()),R(!1),y({}),G()},G=c=>{const l=new Date(m),g=new Date(v);var p=Object.keys(P).filter(S=>P[S]);console.log(c),p.length===0&&(p="All"),console.log(l,g,p);var C=a.map(S=>({...S}));X(l,g,p,C,c)},oe=c=>{y(l=>({...l,[c]:!l[c]}))},O=_.th`
  ...
  `;u.useEffect(()=>{const c=[];a.forEach(l=>{c.push(JSON.parse(JSON.stringify(l)))}),[...c].sort((l,g)=>new Date(g.created_at)-new Date(l.created_at)),o(c)},[a]);const X=(c,l,g,p,C)=>{console.log(C),p=z(c,l,p),p=pe(g,p),C&&C.length>0&&(p=he(p,C));const S=[...p].sort((H,J)=>new Date(J.created_at)-new Date(H.created_at));o(S);const T=document.getElementById("locationSearch");T.value=C},he=(c,l)=>{console.log("filter by name: ",l);var g=l.split(",").map(p=>p.trim().toLowerCase());return c=c.filter(p=>{var C=p.location.split(",").map(T=>T.trim().toLowerCase());let S=0;return g.forEach(T=>{C.forEach(H=>{T===H&&S++})}),S>=g.length}),c},z=(c,l,g)=>(g=g.filter(p=>new Date(p.created_at).getTime()>c.getTime()&&new Date(p.created_at).getTime()<l.getTime()),g),pe=(c,l)=>(c!="All"&&(l=l.filter(g=>c.includes(g.type.toString()))),console.log(l),l),ie=c=>{const l=new Date(c.created_at).getTime(),g=`/map/${c.latitude}/${c.longitude}/${l}`;Y(g)},Z=()=>{var c=`ID,Created At,Type,Location,Text,Radius,latitude,longitude
`;t.forEach(C=>{var ne;var{id:S,created_at:T,type:H,location:J,text:ue,radius:me,latitude:fe,longitude:ge}=C,xe=((ne=r.find(be=>be.id===H))==null?void 0:ne.name)||"Other",ye=`${S},"${T}","${xe}","${J}","${ue}",${me},"${fe},${ge}"
`;c+=ye});var l=new Blob([c],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(l),p=document.createElement("a");p.href=g,p.download="hazards_data.csv",document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(g)},q=_.div`
    position: relative;
    z-index: 1000;
   `;return e.jsxs(q,{children:[e.jsx("input",{id:"locationSearch",type:"text",placeholder:"EX: Corvallis, Oregon, US"}),e.jsxs("div",{children:["Start Date:",e.jsx("input",{type:"date",id:"startDate",value:m.split("T")[0],onChange:c=>x(c.target.value)}),"End Date:",e.jsx("input",{type:"date",id:"endDate",value:v.split("T")[0],onChange:c=>I(c.target.value)}),e.jsxs("div",{id:"list1",className:"dropdown-check-list",tabIndex:"100",children:[e.jsx("span",{className:"anchor",onClick:()=>R(!w),children:"Hazard Types"}),w&&e.jsx("ul",{className:"items",children:r.map(c=>e.jsxs("li",{children:[e.jsx("input",{id:c.id,value:c.id,type:"checkbox",checked:P[c.id]||!1,onChange:()=>oe(c.id)}),c.name]},c.id))})]}),e.jsx("button",{onClick:()=>{const c=document.getElementById("locationSearch");console.log(c.value);const l=c.value;G(l)},children:"Submit"}),e.jsx("button",{onClick:f,children:"Clear Filters"}),e.jsx("button",{onClick:Z,children:"Save"})]}),e.jsxs(A,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(O,{children:"ID"}),e.jsx(O,{children:"Created At"}),e.jsx(O,{children:"Type"}),e.jsx(O,{children:"Location"}),e.jsx(O,{children:"Text"}),e.jsx(O,{children:"Radius"})]})}),e.jsx("tbody",{children:t.map(c=>e.jsx(Et,{onClick:()=>ie(c),...c},c.id))})]})]})},$t="/assets/mapillustration-DIBzkvWx.png",Re=D.div`
  // margin-top: 100px;
   margin-left: 10vw;
  // width: 30%;
  display: flex;
...
`,Ht=()=>e.jsx(Lt,{children:e.jsx("div",{className:"content",children:e.jsxs(Re,{children:[e.jsxs(Pe,{children:[e.jsx("h1",{children:"Stay Informed on Local Hazards"}),e.jsx("br",{}),e.jsxs("p",{children:[e.jsx("strong",{children:"Do you value your safety?"}),e.jsx("br",{})," ",e.jsx("strong",{children:"Want to help your loved ones and your community stay safe?"}),e.jsx("br",{})," ",e.jsx("br",{})," We've got you covered, stay up to date and reports hazard in your area with HazardWatch!"]}),e.jsx(Ot,{children:e.jsx(de,{to:"/map",children:"View Map"})})]}),e.jsx(Tt,{children:e.jsx("img",{src:$t,alt:"Map Illustration"})})]})})}),Me=nt`
...
`,Nt="/assets/teamPic-wZFRJGqY.jpg",Rt=()=>e.jsxs(e.Fragment,{children:[e.jsx(Me,{}),e.jsx("html",{children:e.jsx("body",{children:e.jsx(Re,{children:e.jsxs(Pe,{children:[e.jsx("h1",{children:"About Us"}),e.jsxs("section",{children:[e.jsx("h2",{children:"Our Mission"}),e.jsxs("p",{children:["At HazardWatch, we prioritize your safety by providing real-time updates on local hazards.",e.jsx("br",{}),"Our goal is to help you and your loved ones stay informed and prepared for any potential threats in your area.",e.jsx("br",{}),"National and Local alert systems often miss hazards and are succeptible to delay.",e.jsx("br",{}),"We set out to fix this using help from millions keen-eyed people like yourself to provide a trustworthy, constantly updated map of hazard alerts."]})]}),e.jsx("h1",{children:"Development Team"}),e.jsx(Bt,{children:e.jsx("img",{src:Nt,alt:"Team"})}),e.jsxs("section",{children:[e.jsx("a",{href:"https://github.com/CGA15/Corvallis-Hazard-Watch",children:e.jsx("h2",{children:"GitHub"})}),e.jsx("a",{href:"https://github.com/CGA15/Corvallis-Hazard-Watch",children:e.jsx("p",{children:'https://github.com/CGA15/Corvallis-Hazard-Watch"'})}),e.jsx("h2",{children:"Contact Information"}),e.jsx("p",{children:"Email: corvallis-hazardwatch@proton.me"}),e.jsx("p",{children:"Address: 123 Safe Street, Safety City, Safe Country"}),e.jsx("p",{children:e.jsx("b",{children:"**The above address info is a placeholder values because website is still under construction**"})})]})]})})})})]}),Pt=()=>{const{isLoading:a,error:t}=Ce(),o=Fe();return u.useEffect(()=>{o(Be()),o(Le()),o(Se())},[o]),_.h1`
    display: flex
  `,_.div`
  margin-right: 1em;
  border-style: solid;
